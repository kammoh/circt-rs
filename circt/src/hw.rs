...
use circt_sys::capi::{mlirGetDialectHandle__hw__, hwGetBitWidth, hwArrayTypeGet, hwArrayTypeGetElementType, hwTypeIsAArrayType, hwStructTypeGetNumFields, hwStructTypeGet, HWStructFieldInfo, hwArrayTypeGetSize, hwTypeIsAStructType, hwStructTypeGetFieldNum};
use circt_sys::{mlirIdentifierGetFromStr, mlirIdentifierToStr};
...
pub fn dialect() -> DialectHandle {
    DialectHandle::from_raw(unsafe { mlirGetDialectHandle__hw__() })
}
