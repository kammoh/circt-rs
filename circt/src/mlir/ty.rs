...
use circt_sys::capi::{mlirTypeGetContext, MlirType, mlirFunctionTypeGet, mlirFunctionTypeGetNumInputs, mlirFunctionTypeGetResult, mlirFunctionTypeGetNumResults, mlirFunctionTypeGetInput, mlirTypePrint, mlirTypeIsAInteger, mlirIntegerTypeGet, mlirIntegerTypeGetWidth};
